...
#%%-------------------------------------------------------------------------------
### CUSTOM FIXES FOR INDIVIDUAL SITES 
...
## HOLY F#%K - IS THIS REALLY THE BEST WAY TO UPDATE A COLUMN IN PANDAS !?!?
#  THIS IS RIDICULOUS;  JUST USING iloc modifies a copy, not the original df
#  THIS IS MUCH SIMPLER IN R...
