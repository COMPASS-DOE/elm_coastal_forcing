...
def query_noaa_hourly_tide_gauge(station_id, start_date, datum, output_dir):
    ...
    params = {
        ...
        "datum": datum, # 'MLLW',                # "IGLD" or  "NAVD"  # Vertical datum (use MLLW for mean lower low water)
...
if __name__ == '__main__':
    ...
    # # Read in gauge_df
    gauge_df = (
        pd.read_csv('../../data/tide_gauges/all_gauges_list/old/synoptic_tide_gauges.csv', dtype=str)
    ...
    # output dir
    outdir = '../../data/tide_gauges/noaa_coops/predictions'
